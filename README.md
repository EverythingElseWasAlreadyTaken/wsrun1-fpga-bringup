...
Download and flash MicroPython for the RPi Pico onto the waferspace-main-pcb: https://micropython.org/download/RPI_PICO/
...
Python script and example FPGA designs are available in `wsrun1/`.

To move them onto the waferspace-main-pcb we use mpy-repl-tool.
...
Make sure to push the file structure in `wsrun1/board/` to the waferspace-main-pcb. See `wsrun1/README.md` for more information.
